...
class PurchaseReturn(models.Model):
    ...
    net_total_before_return = models.DecimalField('Net Total before return',max_digits=14, decimal_places=2, default=0)
    grant_total_before_return = models.DecimalField('Grant Total before return', max_digits=14, decimal_places=2, default=0)
