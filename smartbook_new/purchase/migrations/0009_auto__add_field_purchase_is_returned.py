...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Purchase.is_returned'
        db.add_column(u'purchase_purchase', 'is_returned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Purchase.is_returned'
        db.delete_column(u'purchase_purchase', 'is_returned')
