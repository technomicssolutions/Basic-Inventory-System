...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PurchaseReturn.net_total_before_return'
        db.add_column(u'purchase_purchasereturn', 'net_total_before_return',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'PurchaseReturn.grant_total_before_return'
        db.add_column(u'purchase_purchasereturn', 'grant_total_before_return',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'PurchaseReturn.discount_before_return'
        db.add_column(u'purchase_purchasereturn', 'discount_before_return',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PurchaseReturn.net_total_before_return'
        db.delete_column(u'purchase_purchasereturn', 'net_total_before_return')

        # Deleting field 'PurchaseReturn.grant_total_before_return'
        db.delete_column(u'purchase_purchasereturn', 'grant_total_before_return')

        # Deleting field 'PurchaseReturn.discount_before_return'
        db.delete_column(u'purchase_purchasereturn', 'discount_before_return')
