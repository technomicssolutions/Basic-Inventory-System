...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sales.net_tax_total'
        db.delete_column(u'sales_sales', 'net_tax_total')

        # Adding field 'Sales.net_taxable_value'
        db.add_column(u'sales_sales', 'net_taxable_value',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Sales.net_tax_total'
        db.add_column(u'sales_sales', 'net_tax_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Sales.net_taxable_value'
        db.delete_column(u'sales_sales', 'net_taxable_value')
