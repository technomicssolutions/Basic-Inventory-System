...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sales.freight_rate'
        db.add_column(u'sales_sales', 'freight_rate',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sales.freight_rate'
        db.delete_column(u'sales_sales', 'freight_rate')
    ...
    models = {
        ...
        u'sales.sales': {
            ...
            'freight_rate': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
