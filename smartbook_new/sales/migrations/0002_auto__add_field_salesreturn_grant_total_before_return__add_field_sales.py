...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalesReturn.grant_total_before_return'
        db.add_column(u'sales_salesreturn', 'grant_total_before_return',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'SalesReturn.net_amount_before_return'
        db.add_column(u'sales_salesreturn', 'net_amount_before_return',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'SalesReturn.discount_before_return'
        db.add_column(u'sales_salesreturn', 'discount_before_return',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Sales.net_amount_after_return'
        db.delete_column(u'sales_sales', 'net_amount_after_return')

        # Deleting field 'Sales.grant_total_after_return'
        db.delete_column(u'sales_sales', 'grant_total_after_return')

    def backwards(self, orm):
        # Deleting field 'SalesReturn.grant_total_before_return'
        db.delete_column(u'sales_salesreturn', 'grant_total_before_return')

        # Deleting field 'SalesReturn.net_amount_before_return'
        db.delete_column(u'sales_salesreturn', 'net_amount_before_return')

        # Deleting field 'SalesReturn.discount_before_return'
        db.delete_column(u'sales_salesreturn', 'discount_before_return')

        # Adding field 'Sales.net_amount_after_return'
        db.add_column(u'sales_sales', 'net_amount_after_return',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Sales.grant_total_after_return'
        db.add_column(u'sales_sales', 'grant_total_after_return',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)
