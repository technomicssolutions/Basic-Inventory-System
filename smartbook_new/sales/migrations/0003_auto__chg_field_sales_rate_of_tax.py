...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sales.rate_of_tax'
        db.alter_column(u'sales_sales', 'rate_of_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))
    def backwards(self, orm):

        # Changing field 'Sales.rate_of_tax'
        db.alter_column(u'sales_sales', 'rate_of_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=3))
    models = {
        u'inventory.item': {
