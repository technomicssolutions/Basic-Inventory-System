...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalesReturnItem.sold_quantity'
        db.add_column(u'sales_salesreturnitem', 'sold_quantity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SalesReturnItem.sold_quantity'
        db.delete_column(u'sales_salesreturnitem', 'sold_quantity')
