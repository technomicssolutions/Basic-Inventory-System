...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sales.kvat_percent'
        db.add_column(u'sales_sales', 'kvat_percent',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Sales.cess_percent'
        db.add_column(u'sales_sales', 'cess_percent',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sales.kvat_percent'
        db.delete_column(u'sales_sales', 'kvat_percent')

        # Deleting field 'Sales.cess_percent'
        db.delete_column(u'sales_sales', 'cess_percent')
    ...
    models = {
        ...
        u'sales.sales': {
            ...
            'cess_percent': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
            ...
            'kvat_percent': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
            'net_amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
            'net_taxable_value': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
