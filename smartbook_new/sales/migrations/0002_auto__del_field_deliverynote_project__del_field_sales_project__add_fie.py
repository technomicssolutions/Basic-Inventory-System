...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DeliveryNote.project'
        db.delete_column(u'sales_deliverynote', 'project_id')

        # Deleting field 'Sales.project'
        db.delete_column(u'sales_sales', 'project_id')

        # Adding field 'Sales.status'
        db.add_column(u'sales_sales', 'status',
                      self.gf('django.db.models.fields.CharField')(default='estimate', max_length=100),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'DeliveryNote.project'
        db.add_column(u'sales_deliverynote', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Project'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sales.project'
        db.add_column(u'sales_sales', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Project'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Sales.status'
        db.delete_column(u'sales_sales', 'status')
