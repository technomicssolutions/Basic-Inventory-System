...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalesItem.rate_of_tax'
        db.add_column(u'sales_salesitem', 'rate_of_tax',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Sales.rate_of_tax'
        db.delete_column(u'sales_sales', 'rate_of_tax')

    def backwards(self, orm):
        # Deleting field 'SalesItem.rate_of_tax'
        db.delete_column(u'sales_salesitem', 'rate_of_tax')

        # Adding field 'Sales.rate_of_tax'
        db.add_column(u'sales_sales', 'rate_of_tax',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)
